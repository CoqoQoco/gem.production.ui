    ...
    <div class="list-search-container">
      ...
      <div class="list-page-title-section">
        <h2 class="list-page-title">
          ...
          {{ $t("goldSize.title") || "จัดการข้อมูลขนาดทอง" }}
        </h2>
      </div>
      ...
      <div class="list-search-bar">
        ...
        <div class="list-search-input-wrapper">
          ...
          <InputText
            ...
            :placeholder="
              $t('goldSize.searchPlaceholder') || 'ค้นหารหัส, ชื่อ (ไทย), ชื่อ (อังกฤษ)...'
            "
        ...
        <!-- Add Gold Size Button -->
        <Button
          :label="$t('goldSize.addGoldSize') || 'เพิ่มขนาดทอง'"
          icon="pi pi-plus"
          @click="handleAdd"
          class="list-search-button"
        />
