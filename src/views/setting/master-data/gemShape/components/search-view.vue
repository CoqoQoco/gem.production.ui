    ...
    <div class="list-search-container">
      ...
      <div class="list-page-title-section">
        <h2 class="list-page-title">
          ...
          {{ $t("gemShape.title") || "จัดการข้อมูลรูปร่างพลอย" }}
        </h2>
      </div>
      ...
      <div class="list-search-bar">
        ...
        <div class="list-search-input-wrapper">
          ...
          <InputText
            ...
            :placeholder="
              $t('gemShape.searchPlaceholder') || 'ค้นหารหัส, ชื่อ (ไทย), ชื่อ (อังกฤษ)...'
            "
        ...
        <!-- Add Gem Shape Button -->
        <Button
          :label="$t('gemShape.addGemShape') || 'เพิ่มรูปร่างพลอย'"
          icon="pi pi-plus"
          @click="handleAdd"
          class="list-search-button"
        />
