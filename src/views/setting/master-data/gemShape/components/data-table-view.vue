<template>
  <div class="list-data-table-container">
    <DataTableComponent
      ...
      :empty-message="$t('gemShape.noData') || 'ไม่พบข้อมูลรูปร่างพลอย'"
      data-key="id"
      :show-gridlines="true"
      :paginator="true"
    ...
    >
      ...
      <template #nameThTemplate="{ data }">
        <div class="list-name-cell">
          <i class="pi pi-shape list-item-icon"></i>
      ...
      <template #isActiveTemplate="{ data }">
        <div class="list-status-cell">
          <Tag
            :value="
              data.isActive
                ? $t('gemShape.columns.active') || 'ใช้งาน'
                : $t('gemShape.columns.inactive') || 'ไม่ใช้งาน'
            "
  ...
  data() {
    return {
      columns: [
        {
          field: "id",
          header: this.$t("gemShape.columns.id") || "ID",
          sortable: true,
          width: "80px",
          align: "center"
        },
        {
          field: "code",
          header: this.$t("gemShape.columns.code") || "รหัสรูปร่าง",
          sortable: true,
          width: "150px"
        },
        {
          field: "nameTh",
          header: this.$t("gemShape.columns.nameTh") || "ชื่อรูปร่าง (ไทย)",
          sortable: true,
          minWidth: "200px"
        },
        {
          field: "nameEn",
          header: this.$t("gemShape.columns.nameEn") || "ชื่อรูปร่าง (อังกฤษ)",
          sortable: true,
          minWidth: "200px"
        },
        {
          field: "isActive",
          header: this.$t("gemShape.columns.status") || "สถานะ",
          sortable: true,
          width: "120px",
          align: "center"
        },
