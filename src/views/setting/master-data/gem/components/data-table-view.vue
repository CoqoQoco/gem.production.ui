<template>
  <div class="list-data-table-container">
    <DataTableComponent
      ...
      :empty-message="$t('gem.noData') || 'ไม่พบข้อมูลพลอย'"
      data-key="id"
      :show-gridlines="true"
      :paginator="true"
    ...
    >
      ...
      <template #nameThTemplate="{ data }">
        <div class="list-name-cell">
          <i class="pi pi-diamond list-item-icon"></i>
      ...
      <template #isActiveTemplate="{ data }">
        <div class="list-status-cell">
          <Tag
            :value="
              data.isActive
                ? $t('gem.columns.active') || 'ใช้งาน'
                : $t('gem.columns.inactive') || 'ไม่ใช้งาน'
            "
  ...
  data() {
    return {
      columns: [
        {
          field: "id",
          header: this.$t("gem.columns.id") || "ID",
          sortable: true,
          width: "80px",
          align: "center"
        },
        {
          field: "code",
          header: this.$t("gem.columns.code") || "รหัสพลอย",
          sortable: true,
          width: "150px"
        },
        {
          field: "nameTh",
          header: this.$t("gem.columns.nameTh") || "ชื่อพลอย (ไทย)",
          sortable: true,
          minWidth: "200px"
        },
        {
          field: "nameEn",
          header: this.$t("gem.columns.nameEn") || "ชื่อพลอย (อังกฤษ)",
          sortable: true,
          minWidth: "200px"
        },
        {
          field: "color",
          header: this.$t("gem.columns.color") || "สี",
          sortable: false,
          width: "150px"
        },
        {
          field: "isActive",
          header: this.$t("gem.columns.status") || "สถานะ",
          sortable: true,
          width: "120px",
          align: "center"
        },
