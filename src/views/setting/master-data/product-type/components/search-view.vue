    ...
    <div class="list-search-container">
      ...
      <div class="list-page-title-section">
        <h2 class="list-page-title">
          ...
          {{ $t("productType.title") || "จัดการประเภทสินค้า" }}
        </h2>
      </div>
      ...
      <div class="list-search-bar">
        ...
        <div class="list-search-input-wrapper">
          ...
          <InputText
            ...
            :placeholder="
              $t('productType.searchPlaceholder') || 'ค้นหารหัส, ชื่อ (ไทย), ชื่อ (อังกฤษ)...'
            "
        ...
        <Button
          :label="$t('productType.addProductType') || 'เพิ่มประเภทสินค้า'"
          icon="pi pi-plus"
          @click="handleAdd"
          class="list-search-button"
        />
