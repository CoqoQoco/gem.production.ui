<template>
  <div class="list-data-table-container">
    <DataTableComponent
      ...
      :empty-message="$t('workerGuide.noData') || 'ไม่พบข้อมูลไกด์'"
      data-key="id"
      :show-gridlines="true"
      :paginator="true"
      ...
      <template #isActiveTemplate="{ data }">
        <div class="list-status-cell">
          <Tag
            :value="
              data.isActive
                ? $t('workerGuide.columns.active') || 'ใช้งาน'
                : $t('workerGuide.columns.inactive') || 'ไม่ใช้งาน'
            "
...
export default {
  ...
  data() {
    return {
      columns: [
        {
          field: "id",
          header: this.$t("workerGuide.columns.id") || "ID",
          sortable: true,
          width: "80px",
          align: "center"
        },
        {
          field: "code",
          header: this.$t("workerGuide.columns.code") || "รหัส",
          sortable: true,
          width: "150px"
        },
        {
          field: "nameTh",
          header: this.$t("workerGuide.columns.nameTh") || "ชื่อ (ไทย)",
          sortable: true,
          minWidth: "180px"
        },
        {
          field: "nameEn",
          header: this.$t("workerGuide.columns.nameEn") || "ชื่อ (อังกฤษ)",
          sortable: true,
          minWidth: "180px"
        },
        {
          field: "email",
          header: this.$t("workerGuide.columns.email") || "อีเมล",
          sortable: false,
          minWidth: "200px"
        },
        {
          field: "tel",
          header: this.$t("workerGuide.columns.tel") || "เบอร์โทร",
          sortable: false,
          width: "130px"
        },
        {
          field: "gender",
          header: this.$t("workerGuide.columns.gender") || "เพศ",
          sortable: true,
          width: "100px",
          align: "center"
        },
        {
          field: "isActive",
          header: this.$t("workerGuide.columns.status") || "สถานะ",
          sortable: true,
          width: "120px",
          align: "center"
        },
  ...
  methods: {
    getGenderLabel(gender) {
      const genderMap = {
        'M': this.$t('workerGuide.gender.male') || 'ชาย',
        'F': this.$t('workerGuide.gender.female') || 'หญิง'
      }
